...
_boost = {**cfg.get("booster", REAL), **cfg.get("booster_over", {})}
rb = ResidualBooster(n_jobs=threads, **_boost).fit(meta, P.X, visible, Yhat)
...
json.dump({
    ...
    "fit_offset": cfg.get("fit_offset", True), "booster": _boost,
